...
const PortfolioSection = () => {
  const featuredProject = {
    ...
    results: [{
      ...
      metric: "70%",
      description: "Faster grievance resolution"
    }, {
      metric: "100%",
      description: "GDPR compliance achieved"
    }, {
      metric: "2,000+",
      description: "Students using the system daily"
    }],
    ...
    features: ["Automated student record management", "RFID/Biometric attendance integration", "Exam scheduling and grade management", "Faculty coordination portals", "Real-time analytics dashboard", "GDPR-compliant data handling"]
  };
  const otherProjects = [{
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            <div>
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-2">
                  {featuredProject.features.map((feature, index) => <div key={index} className="flex items-center text-sm">
              ...
              <div className="mb-6">
                ...
                <div className="flex flex-wrap gap-2">
                  {featuredProject.technologies.map((tech, index) => <span key={index} className="bg-developer-teal/20 text-developer-teal-light px-3 py-1 rounded text-sm">
                      {tech}
                    </span>)}
                </div>
              </div>
            ...
            <div>
              <div className="grid grid-cols-2 gap-4 mb-8">
                {featuredProject.results.map((result, index) => <div key={index} className="text-center bg-white/10 rounded-lg p-4">
